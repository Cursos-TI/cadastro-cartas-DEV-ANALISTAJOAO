...
int main() {
  ...
  char codigo_carta1[5]; // uma letra escolhida e um número de 01 a 04
  ...
  float quociente_densidade_populacional1; // população da cidade dividida pela área da cidade
  float quociente_pib_percapita1; // pib da cidade dividido pela população da cidade

  // Variáreis para carta 2:

  char estado2; // Uma letra entre A E H (sendo 8 estados com 4 cidades cada estado)
  char codigo_carta2[5]; // uma letra escolhida e um número de 01 a 04
  ...
  float quociente_densidade_populacional2; // população da cidade dividida pela área da cidade
  float quociente_pib_percapita2; // pib da cidade dividido pela população da cidade
  ...
  */
  ...
  printf("Digite o PIB da cidade em milhões ou bilhões:\n");
  ...
  quociente_densidade_populacional1 = (float) populacao1 / area1; // cálculo da densidade populacional da cidade 1
  quociente_densidade_populacional2 = (float) populacao2 / area2; // cálculo da densidade populacional da cidade 2
  quociente_pib_percapita1 = (float) (pib1 * 1000000000.00) / populacao1; // cálculo do PIB per capita da cidade 1
  quociente_pib_percapita2 = (float) (pib2 * 1000000000.00) / populacao2; // cálculo do PIB per capita da cidade 2
  ...
  printf("Densidade Populaional: %.2f hab/km²\n", quociente_densidade_populacional1); // exibição da densidade populacional da carta 1 com 2 casas decimais
  printf("PIB per capita: %.2f reais\n", quociente_pib_percapita1); // exibição do PIB per capita da carta 1 com 2 casas decimais
  ...
  printf("Densidade Populacional: %.2f hab/km²\n", quociente_densidade_populacional2); // exibição da densidade populacional da carta 2 com 2 casas decimais
  printf("PIB per capita: %.2f reais\n", quociente_pib_percapita2); // exibição do PIB per capita da carta 2 com 2 casas decimais
